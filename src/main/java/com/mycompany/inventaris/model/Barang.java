...
public class Barang {
    ...
    public Barang(int id_barang, String kode_barang, String nama_barang, String kategori,
                  int stok, String kondisi, String lokasi, String status, String deskripsi) {
    ...
    public void setIdBarang(int id_barang) { this.id_barang = id_barang; }

    public String getKode() { return kode_barang; }
    public void setKode(String kode_barang) { this.kode_barang = kode_barang; }

    public String getNama() { return nama_barang; }
    public void setNama(String nama_barang) { this.nama_barang = nama_barang; }
